class AlphabetController < UIViewController
  ...
  def tableView(tableView, cellForRowAtIndexPath: indexPath) @reuseIdentifier ||= "CELL_IDENTIFIER"
  ...
  # Must have • tableView:cellForRowAtIndexPath: && • tableView:numberOfRowsInSection:
  #def tableView(tableView, numberOfRowsInSection: section)
